...
<div style="position: -webkit-sticky;
	...
	color: white;
    height: auto;">
    <div id="running-text-tendik" class="marquee" style="overflow: hidden;"></div>
</div>
...
<footer class="main-footer d-none">
    ...
    <div class="d-none float-right d-none d-sm-inline-block">
        <b>Version</b> <?= defined('APP_VERSION') ? APP_VERSION : '1.0.0' ?>
    </div>
</footer>
...
<script>
    ...
    var runningText = [];
    <?php if (isset($running_text)): ?>
    runningText = JSON.parse('<?= json_encode($running_text) ?>');
    <?php endif; ?>
    ...
    if (runningText.length > 0) {
        ...
        teks = '<span class="ml-3 mr-3">Selamat datang di Portal Tendik</span> &bull; ';
    }

    $('#running-text-tendik').html(teks);
