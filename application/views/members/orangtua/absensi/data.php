            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card card-indigo">
                        <div class="card-header">
                            <div class="card-title text-white">
                                Detail Kehadiran Bulan <?= $arrBulan[(int)date('m')] ?>
                            </div>
                        </div>
                        <div class="card-body">
                            <?php if ($kbm != null) :
                                ...
                                <table id="tableMapel" class="w-100 table table-bordered table-sm table-responsive">
                                    ...
                                    foreach ($arrtgl as $tgl) :
                                        ...
                                        if ($hari != 7 && (int)$tgl <= (int)$tanggal) :
                                            ...
                                            $waktu = $kbm->kbm_jam_mulai;
                                            $jmlMapel = $kbm->kbm_jml_mapel_hari;
                                            $materi = isset($sebulan['materis'][$tgl]) ? $sebulan['materis'][$tgl] : [];
                                            ...
                                            if (count($jdwl) > 0) :
                                                ...
                                                for ($i = 0; $i < $jmlMapel; $i++) :
                                                    ...
                                                    if (in_array($jamke, $arrIst)) :
                                                        ...
                                                        $currentMapel = isset($jdwl[$jamke]) ? $jdwl[$jamke] : null;
                                                        $adaMateri = $currentMapel && isset($materi[$currentMapel->id_mapel]) && isset($materi[$currentMapel->id_mapel][$jamke]) && isset($materi[$currentMapel->id_mapel][$jamke][1]);
                                                        $adaTugas = $currentMapel && isset($materi[$currentMapel->id_mapel]) && isset($materi[$currentMapel->id_mapel][$jamke]) && isset($materi[$currentMapel->id_mapel][$jamke][2]);
                                                        ...
                                                        if ($adaMateri) {
                                                            if ($absenMateri != '' && $absenMateri != '-') {
                                                                $str1 = $materi[$currentMapel->id_mapel][$jamke][1]->jadwal_materi . ' ' . $jamSampai->format('H:i:s');
                                                        ...
                                                        if ($adaTugas) {
                                                            if ($absenTugas != '' && $absenTugas != '-') {
                                                                $str1 = $materi[$currentMapel->id_mapel][$jamke][2]->jadwal_materi . ' ' . $jamSampai->format('H:i:s');
                                                                $date1 = new DateTime($str1);
