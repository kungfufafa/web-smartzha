                                ...
                                if (count($nilai_materi) > 0):?>
                                    <table class="table table-hover w-100" id="table-nilai-materi" style="line-height: 1">
                                        ...
                                        foreach ($nilai_materi as $nil) :
                                            ?>
                                            <tr onclick="showDialog(this)" data-text="<?= htmlspecialchars($nil->catatan) ?>">
                                ...
                                <table class="table w-100" id="table-nilai-ujian">
                                    ...
                                    if (count($jadwal) > 0) :
                                        ...
                                        foreach ($jadwal as $j) :
                                            ...
                                            $skor_siswa = isset($skor[$j->id_jadwal]) ? $skor[$j->id_jadwal] : null;
                                            $total = '-';
                                            if ($skor_siswa) {
                                                $total = !$hanya_pg && isset($skor_siswa->dikoreksi) && $skor_siswa->dikoreksi == 0 ? '*' : ($j->hasil_tampil == '0' ? '**' : $skor_siswa->skor_total);
                                            }
                                            ?>
                                            <tr>
                                                <td class="text-center"><?= $no ?></td>
                                                ...
                                                <td class="text-center">
                                                    <button type="button"
                                                            data-koreksi="<?= $skor_siswa && isset($skor_siswa->dikoreksi) ? $skor_siswa->dikoreksi : '0' ?>"
