...
<section class="d-flex align-items-center">
    <div class="container">
        <div class="row">
            <div class="col-6">
                <img class="mt-3 mb-3" width="30" height="30" src="<?= base_url('assets/img/smartzha_circle.png') ?>" alt="Smartzha">
                <span class="text-lg"><b>SMARTZHA</b></span>
            </div>
