...
<head>
    ...
    <title>Smartzha Installer</title>
            ...
            <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 aos-init aos-animate" data-aos="fade-up">
                <div class="text-center text-md-left">
                    <div class="mb-3 text-white">
                        <img style="width:100px; height:auto;" src="<?= $base_url ?>assets/img/smartzha_white.svg" alt="Smartzha">
                        <span class="h1 align-bottom">SMARTZHA</span>
                        <span class="h1 align-bottom"> CBT</span>
                    </div>
                    <div class="h2 text-white">
                        Platform ujian, rapor, dan e-learning
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        $('#create').submit(function (e) {
            ...
            $.ajax({
                url: '<?= $base_url ?>installer/install.php',
                method: 'POST',
                data: data,
